...
''');
  ...
  var appDigestsOutput = dartEntrypointId.changeExtension(
    digestsEntrypointExtension,
  );
  var mergedMetadataOutput = dartEntrypointId.changeExtension(
  ...
  for (AssetId jsId in transitiveJsModules) {
    ...
    String moduleName = ddcModuleName(jsId);
  ...
  bootstrapContent.write(_appBootstrap(moduleName: appModuleName, moduleScope: appModuleScope));
...
String _appBootstrap({required String moduleName, required String moduleScope}) =>
    '''
